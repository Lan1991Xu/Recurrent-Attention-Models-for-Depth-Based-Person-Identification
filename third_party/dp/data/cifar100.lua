...
function Cifar100:__init(config)
    ...
    = xlua.unpack({ config },
        ...
        },
        {
            arg = 'train_file',
            type = 'string',
            default = 'cifar-100-binary/train.bin',
            help = 'name of test_file'
        },
        {
            arg = 'test_file',
            type = 'string',
            default = 'cifar-100-binary/test.bin',
            help = 'name of test_file'
        },
        {
            arg = 'data_path',
    ...
    self._coarse_classes = self:loadClasses('cifar-100-binary/coarse_label_names.txt')
    assert(#self._coarse_classes == 20)
    self._fine_classes = self:loadClasses('cifar-100-binary/fine_label_names.txt')
