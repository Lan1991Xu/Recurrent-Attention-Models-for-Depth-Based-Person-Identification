...
function Kmeans:updateOutput(input)
    ...
    self._expandedSamples:resize(self.k, batchSize, self.dim):copy(self._tempExpanded)
    ...
    self._expandedWeight:resize(self.k, batchSize, self.dim):copy(self._tempWeightExp)
